...
static const char qt_meta_stringdata_AddChannelDialog[] = {
    "AddChannelDialog\0\0on_btn__AddChannel_clicked()\0"
};

void AddChannelDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        AddChannelDialog *_t = static_cast<AddChannelDialog *>(_o);
        switch (_id) {
        case 0: _t->on_btn__AddChannel_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData AddChannelDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject AddChannelDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddChannelDialog,
      qt_meta_data_AddChannelDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AddChannelDialog::getStaticMetaObject() { return staticMetaObject; }
